...
public interface OrderService {
	...
	BigDecimal getPrice(Map<String, Object> query_map) ;

	BigDecimal getAmount(Map<String, Object> query_map);

	Integer getQuantity(Map<String, Object> query_map);
	...
	List<BigDecimal> getPaymentAmount(Map query_map);//统计支付金额

	List<Map> getOrderSource(Map query_map);//订单来源（地图展示）

	List<Map> getOrderSourcePie(Map query_map); //订单来源(饼状图展示)

	List<Map> getYearOrderSum(Map query_map); //按年统计订单量

	List<Map> productOrderProportions(Map query_map); //产品订单量占比

	List<Map> getOrderSourceByCity(Map query_map);//订单来源（地图展示）

	List<Map> getOrderSourceCityOrderByDesc(Map query_map);//订单地区排名

	List<Map> getProductQuantityOrderByDesc(Map query_map);//产品按销量排序

	List<Map> getThisWeek(Map query_map);//本周订单量+订单金额

	List<Map> getLastWeek(Map query_map);//上周订单量+订单金额

	List<Map> getThisWeekConversionRate(Map query_map);//本周订单量转化率

	List<Map> getLastWeekConversionRate(Map query_map);//上周订单量转化率
	...
	List<Map> getComparativeAnalysisOfSales(Map query_map); //销售额对比分析
	...
	List<Map> getOrderArea(Map query_map); //城市排名分析
